...
/**
 * @brief A base for any sink in  to implement.
 *
 * Sinks are 's abstraction for destinations that logged messages can be sent to. They are the backbone of the
...
class BaseSink {
    public:
         ...
         * <h3> Example Usage </h3>
         * @code
         * ::BaseSink combinedSink({::telemetrySink(), ::infoSink()});
         ...
         * <h3> Example Usage </h3>
         * @code
         * sink.log(::Level::INFO, "{} from the logger!", "Hello");
         * @endcode
    ...
    protected:
         ...
         * <h3> Example Usage </h3>
         * @code
         * infoSink()->setFormat("[] -- {time} -- {level}: {Message}");
         * infoSink()->info("hello");
